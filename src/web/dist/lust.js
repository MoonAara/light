...
var El = module.exports = Class(function(html, opts) {
    ...
    move: function(dest) { // specify top/left/width/height
        var T = this;
        if(T.movement) {
            T.movement.stop();
        }
        ...
        T.movement = morph(T.el, dest);
    },
    // use this for things besides movement,
    // for movement use move
    anim: function(styles) { // see Morpheus docs
        var T = this,
            anims = T.animations;
        _.extend(styles, {
            complete: function() {
        ...
        if(anims.length === 1) {
            anims.pop();
            T.running = morph(T.el, styles);
        }
        console.log(T.el, anims);
        return anims.length;
    },
...
},{"../../common/class":14,"../ext/morpheus":7,"./events":3,"underscore":1}],3:[function(require,module,exports){
var _ = require("underscore"),
...
},{"../ext/jwerty":6,"underscore":1}],4:[function(require,module,exports){
...
},{"../../common/class":14,"./xyz":5,"underscore":1}],5:[function(require,module,exports){
var _ = require("underscore"),
    Class = require("../../common/class");
...
},{"../../common/class":14,"underscore":1}],6:[function(require,module,exports){
/*
...
Editor = module.exports = Class(function(root, authorid){
    ...
    T.word = new Word(T.mesh);
    //T.docs = new Documents(T.mesh);
    //T.base = new Base(author);
    //T.send = new Message();
    ...
    _.each(["Cinzel","Inconsolata"], function(family) {
        T.word.font(family);
    });
...
},{"../../common/class":14,"../../common/links":15,"./mesh":11,"./word":12,"underscore":1}],10:[function(require,module,exports){
// Moon Aara, 2017+
...
},{"../../common/class":14,"../core/el":2,"./editor":9,"underscore":1}],11:[function(require,module,exports){
...
var Mesh = module.exports = Class(function(html, opts) {
    ...
    //
    //---------------------------------------------
    seeker: function(x, y, opts) {
        var T = this,
            seeker = new XY(x, y, z, function(s) {
                T.update(s, true);    
            });
            if(typeof x === "object") opts = y;
            _.extend(seeker, {
    ...
    // the 'x' parameter is
    // an object with (x,y,z) defined 
    direct: function(seeker, x, y) {
        var T = this,
            old_goal = seeker.goal;
        if(!y) {
            seeker.goal = x;
        } else {
            seeker.goal = new XY(x,y,z);
        }
        T.moving[seeker.id] = seeker;
    ...
    // the 'by_x' parameter is 
    // a single XY vector
    shove: function(seeker, by_x, by_y) {
        seeker.vel.add(new XY(by_x, by_y));
        T.moving[seeker.id] = seeker;
    },
    moveby: function(seeker, by_x, by_y) {
        seeker.goal.add(new XY(by_x, by_y));
        T.moving[seeker.id] = seeker;
    },
    tangent: function(seeker) {
        return new XY(-vel.y, vel.x);    
    ...
    write: function(block, text, style) {
        var T = this, opts = {};
        if(style) {
            opts.fontSize = style.size;
            opts.fontFamily = style.font+"px";
    ...
    adjust: function(block) {
        ...
        T.direct(block.bl, new XY(rect.right, rect.bottom));
    }
});

},{"../../common/class":14,"./xy":13,"underscore":1}],12:[function(require,module,exports){
var _ = require("underscore"),
...
},{"../../common/class":14,"../core/el":2,"../core/mesh":4,"../ext/webfont":8,"underscore":1}],13:[function(require,module,exports){
var _ = require("underscore"),
    Class = require("../../common/class");
...
},{"../../common/class":14,"underscore":1}],14:[function(require,module,exports){
var _ = require("underscore");
